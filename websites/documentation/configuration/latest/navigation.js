...
const configuration = [
  ...
  { title: 'Guides', children: [
    ...
    { title: 'Using the latest runtime', children: [
      { title: 'Overview' },
      { title: 'Installing the latest runtime' },
      { title: 'Installing the latest CLI' },
  ...
  { title: 'Reference', children: [
    ...
    { title: 'Creating the read model', children: [
      ...
      { title: 'Defining transformations', keywords: [ 'map', 'filter' ]},
    ...
    { title: 'Configuring an application', children: [
      ...
      { title: 'Using a custom host', keywords: [ 'certificate' ]},
