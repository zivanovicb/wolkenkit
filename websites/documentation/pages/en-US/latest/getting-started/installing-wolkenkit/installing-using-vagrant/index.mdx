...
<p>
  To run wolkenkit you need Vagrant { props.versions.vagrant } or higher. To setup Vagrant, follow the installation guide provided in the <a href='https://www.vagrantup.com/intro/getting-started/install.html'>Vagrant documentation</a>.
</p>
