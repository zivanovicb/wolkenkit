...
<StaticImage variant='wide' src='architecture-from-client-to-broker.svg' alt='Architecture: From client to broker' />
...
<StaticImage variant='wide' src='architecture-client-broker-and-core.svg' alt='Architecture: Client, broker and core' />
...
<StaticImage variant='wide' src='architecture-distributed-by-default.svg' alt='Architecture: Distributed by default' />
