...
Ideally you can also include a [short but complete code sample](https://jonskeet.uk/csharp/complete.html) to reproduce the issue. Anyway, depending on the issue, we know that this is not always possible.
