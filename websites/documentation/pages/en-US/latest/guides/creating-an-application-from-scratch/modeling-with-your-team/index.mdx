import { Hint, StaticImage } from '../../../../../../components';
...
<StaticImage src='chat-commands.png' alt='The chat application' />
...
<StaticImage src='aggregate-message.png' alt='The message aggregate' />
...
<StaticImage src='chat-lists.png' alt='The chat application' />
