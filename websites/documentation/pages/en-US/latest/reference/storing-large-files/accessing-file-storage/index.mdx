...
<p>
  The depot SDK has been tested against Chrome { props.versions.chrome }+ and Node.js  { props.versions.node }+. Other platforms may work as well, they have just not been tested.
</p>
...
<Code language='shell'>{`
  $ npm install wolkenkit-depot-client@${props.versions.depotClientSdkJs}
`}</Code>
