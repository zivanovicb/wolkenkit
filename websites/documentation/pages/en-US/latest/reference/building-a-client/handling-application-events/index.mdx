...
The client application is an <VersionedLink href='https://nodejs.org/dist/v#VERSIONS.NODE#/docs/api/events.html#events_class_eventemitter'>EventEmitter</VersionedLink> that emits multiple lifecycle events.
