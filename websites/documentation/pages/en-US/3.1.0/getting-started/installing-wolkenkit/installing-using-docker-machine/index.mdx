...
<p>
  To run wolkenkit you need Docker { props.versions.docker } or higher. To setup Docker using Docker Machine, <a href='https://docs.docker.com/toolbox/overview/'>download and install Docker Toolbox</a>.
</p>
...
<p>
  To run wolkenkit you need Node.js { props.versions.node } or higher. We recommend installing Node.js using [nvm](https://github.com/creationix/nvm), which enables switching between different Node.js versions.
</p>
