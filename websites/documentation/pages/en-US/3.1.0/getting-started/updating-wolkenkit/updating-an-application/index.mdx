...
For details, see [protecting an application](../../../reference/using-the-cli/protecting-an-application/) and [storing data permanently](../../../reference/using-the-cli/storing-data-permanently/).
