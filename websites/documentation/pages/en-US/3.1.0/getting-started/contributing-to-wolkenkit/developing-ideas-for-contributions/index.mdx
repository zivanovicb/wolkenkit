import { Hint, VersionedLink } from '../../../../../../components';
...
A helpful contribution can be to correct a typo or to improve and enhance an explanation that is too vague. For this purpose, each page of the documentation contains a link at the bottom, which you can use to directly <VersionedLink href='https://github.com/thenativeweb/wolkenkit/edit/monorepo-documentation/websites/docs/pages/en-US/#VERSION#/getting-started/contributing-to-wolkenkit/getting-ideas-for-contributions/index.mdx'>edit the page</VersionedLink> on GitHub.
